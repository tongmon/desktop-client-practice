...
Widget::Widget(QWidget *parent)
    : QMainWindow(parent)
{
    auto mainWidget = new QQuickWidget(QUrl(QStringLiteral("qrc:/qml/TitleBar.qml")), this);
    ...
    // auto menu = new QQuickWidget(QUrl(QStringLiteral("qrc:/qml/TitleBar.qml")), this);
    // titleLayout->addWidget(menu);
    // menu->setResizeMode(QQuickWidget::SizeRootObjectToView);
    // menu->setFixedHeight(reinterpret_cast<QWinWidget *>(parent)->TOOLBARHEIGHT);
