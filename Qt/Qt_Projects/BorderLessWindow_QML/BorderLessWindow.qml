...
Window {
    ...
    property int adjustWindowAreaSize: 10
    ...
    Rectangle {
        ...
        // 위 창 크기 조절
        MouseArea {
            height: adjustWindowAreaSize
            width: parent.width - adjustWindowAreaSize * 2
            x: parent.x + adjustWindowAreaSize
            anchors.top: parent.top
            visible: mainWindow.visibility == Window.Maximized ? false : true
        ...
        // 오른쪽 창 크기 조절
        MouseArea {
            height: parent.height - adjustWindowAreaSize
            width: adjustWindowAreaSize
            visible: mainWindow.visibility == Window.Maximized ? false : true
            ...
            Item {
                ...
                Image {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            mainWindow.visibility == Window.Maximized ? mainWindow.showNormal() : mainWindow.showMaximized()
                        }
